...
public class ColorPickerView extends View {
     ...
     */
    private final static int BORDER_WIDTH_PX = 3;

    /**
     * The round size in pixels of the border
     * surrounding all color panels.
     */
    private final static int BORDER_ROUND_DP = 6;

    /**
     * The round size in pixels of the border
     * surrounding all color panels.
     */
    private final static int TRACKER_BORDER_ROUND_DP = 50;
    ...
    private void drawSatValPanel(Canvas canvas) {
        ...
        if (BORDER_WIDTH_PX > 0) {
            ...
            canvas.drawRoundRect(drawingRect.left, drawingRect.top, rect.right + BORDER_WIDTH_PX, rect.bottom + BORDER_WIDTH_PX, DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP), DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP), borderPaint);
        }
        ...
        if (satValBackgroundCache == null || satValBackgroundCache.value != hue) {
            ...
            satValBackgroundCache.canvas.drawRoundRect(0, 0, satValBackgroundCache.bitmap.getWidth(), satValBackgroundCache.bitmap.getHeight(), DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP) - 2, DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP) - 2, satValPaint);
    ...
    private void drawHuePanel(Canvas canvas) {
        ...
        if (BORDER_WIDTH_PX > 0) {
            ...
            canvas.drawRoundRect(rect.left - BORDER_WIDTH_PX, rect.top - BORDER_WIDTH_PX, rect.right + BORDER_WIDTH_PX, rect.bottom + BORDER_WIDTH_PX, DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP), DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP), borderPaint);
        }
...
//                hueBackgroundCache.canvas.drawRoundRect(rect.left, rect.top, rect.right, rect.bottom, BORDER_ROUND_PX, BORDER_ROUND_PX, linePaint);
            }
        }

        canvas.drawBitmap(getRoundedCornerBitmap(hueBackgroundCache.bitmap, DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP) - 2), null, rect, null);
        ...
        canvas.drawRoundRect(r, DrawingUtils.dpToPx(getContext(), TRACKER_BORDER_ROUND_DP), DrawingUtils.dpToPx(getContext(), TRACKER_BORDER_ROUND_DP), hueAlphaTrackerPaint);
    }


    public static Bitmap getRoundedCornerBitmap(Bitmap bitmap, int corner_radius) {
    ...
    private void drawAlphaPanel(Canvas canvas) {
        ...
        alphaPatternDrawable.setCornerSize(DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP) - 2);
        ...
        canvas.drawRoundRect(new RectF(rect), DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP), DrawingUtils.dpToPx(getContext(), BORDER_ROUND_DP), alphaPaint);
