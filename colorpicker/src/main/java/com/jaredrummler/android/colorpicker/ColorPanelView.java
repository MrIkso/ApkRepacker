...
public class ColorPanelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        borderWidthPx = DrawingUtils.dpToPx(context, 2);
    ...
    protected void onDraw(Canvas canvas) {
        borderColor = Color.rgb(Color.red(color) * 192 / 256, Color.green(color) * 192 / 256, Color.blue(color) * 192 / 256);
    ...
    private void setUpColorRect() {
        ...
        alphaPattern = new AlphaPatternDrawable(DrawingUtils.dpToPx(getContext(), 40)); /////////////////////////////////////////////////////////////
