...
public class MenuFactory {
  ...
  //      menuItemInfos.add(new MenuItemInfo(MenuGroup.FILE, R.id.action_new_file, NONE, R.drawable.ic_add, R.string.new_file));
       ...
       // menuItemInfos.add(new MenuItemInfo(MenuGroup.FILE, R.id.action_save_as, SAVE_AS, R.drawable.ic_save_white, R.string.save_as));
        ...
        menuItemInfos.add(new MenuItemInfo(MenuGroup.EDIT, R.id.action_goto_line, GOTO_INDEX, R.drawable.ic_goto_line, R.string.goto_line));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.EDIT, R.id.action_smali_java, NONE, R.drawable.ic_java, R.string.smali_java));
