...
public class MenuFactory {
    ...
    public static boolean isCheckboxMenu(int id) {
        return id == R.id.m_readonly || id == R.id.m_fullscreen || id == R.id.m_hide_symbol_panel;
    }
    ...
    public static boolean isChecked(Context context, int id) {
        switch (id) {
            ...
            case R.id.m_hide_symbol_panel:
                return Pref.getInstance(context).isHidePanel();
        }
        return false;
    }
    ...
    private void initAllMenuItem() {
     //   menuItemInfos.add(new MenuItemInfo(MenuGroup.FILE, R.id.m_new, Command.CommandEnum.NONE, R.drawable.ic_add_white_24dp, R.string.new_file));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.FILE, R.id.m_save, Command.CommandEnum.SAVE, R.drawable.ic_save_dark, R.string.save));
...
//        menuItemInfos.add(new MenuItemInfo(MenuGroup.EDIT,  R.id.m_select_all,     Command.CommandEnum.SELECT_ALL,        R.drawable.m_select_all, R.string.select_all));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.EDIT, R.id.m_undo, Command.CommandEnum.UNDO, R.drawable.ic_undo, R.string.undo));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.EDIT, R.id.m_redo, Command.CommandEnum.REDO, R.drawable.ic_redo, R.string.redo));
...
//   menuItemInfos.add(new MenuItemInfo(MenuGroup.FILE, R.id.m_open, Command.CommandEnum.OPEN, R.drawable.ic_folder_open_white_24dp, R.string.open));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.FIND, R.id.m_find_replace, Command.CommandEnum.FIND, R.drawable.ic_find_in_page, R.string.find_or_replace));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.FIND, R.id.m_goto_top, Command.CommandEnum.GOTO_TOP, R.drawable.ic_vertical_align_top, R.string.jump_to_start));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.FIND, R.id.m_goto_end, Command.CommandEnum.GOTO_END, R.drawable.ic_vertical_align_bottom, R.string.jump_to_end));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.FIND, R.id.m_goto_line, Command.CommandEnum.GOTO_LINE, R.drawable.ic_goto_line, R.string.goto_line));
     ...
     //   menuItemInfos.add(new MenuItemInfo(MenuGroup.VIEW, R.id.m_theme, Command.CommandEnum.THEME, R.drawable.ic_style_white_24dp, R.string.change_theme));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.VIEW, R.id.m_fullscreen, Command.CommandEnum.FULL_SCREEN, R.drawable.ic_fullscreen, R.string.fullscreen_mode));
       ...
       // menuItemInfos.add(new MenuItemInfo(MenuGroup.VIEW,  R.id.m_symbol, Command.CommandEnum.NONE, R.drawable.m_symbol, R.string.symbol));
        ...
        menuItemInfos.add(new MenuItemInfo(MenuGroup.VIEW, R.id.m_highlight, Command.CommandEnum.NONE, R.drawable.ic_highlight, R.string.highlight_language));
        menuItemInfos.add(new MenuItemInfo(MenuGroup.VIEW, R.id.m_encoding, Command.CommandEnum.NONE, R.drawable.ic_encoding, R.string.encoding));
