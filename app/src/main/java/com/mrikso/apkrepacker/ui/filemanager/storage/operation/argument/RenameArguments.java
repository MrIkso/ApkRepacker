...
public class RenameArguments extends FileOperation.Arguments {
    ...
    private RenameArguments(@NonNull File fileToRename, @NonNull String newName, @NonNull BaseFilesFragment fragment) {
        super(new File(fileToRename.getParent(), newName));
        this.fileToRename = fileToRename;
        this.mFragment = fragment;
    }

    public static RenameArguments renameArguments(@NonNull File fileToRename, @NonNull String newName, @NonNull BaseFilesFragment fragment) {
        return new RenameArguments(fileToRename, newName, fragment);
    }
