...
public class MoveArguments extends FileOperation.Arguments {
    ...
    private MoveArguments(@NonNull List<FileHolder> toMove, @NonNull File to, @NonNull BaseFilesFragment fragment) {
        super(to);
        this.filesToMove = toMove;
        this.mFragment = fragment;
    }

    public static MoveArguments moveArgs(List<FileHolder> toMove, File to, @NonNull BaseFilesFragment fragment) {
        return new MoveArguments(toMove, to, fragment);
    }

    @NonNull
    public List<FileHolder> getFilesToMove() {
        return Collections.unmodifiableList(filesToMove);
    }
