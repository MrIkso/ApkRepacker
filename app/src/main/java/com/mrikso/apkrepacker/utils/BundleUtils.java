...
public class BundleUtils {
    ...
    @Nullable
    public static <T extends Parcelable> T getParcelable(@NonNull Bundle bundle, @Nullable String key) {
    ...
    @Nullable
    public static <T extends Parcelable> ArrayList<T> getParcelableArrayList(@NonNull Bundle bundle, @Nullable String key) {
        return ensureClassLoader(bundle).getParcelableArrayList(key);
    }

    @Nullable
    public static <T extends Parcelable> SparseArray<T> getSparseParcelableArray(@NonNull Bundle bundle, @Nullable String key) {
    ...
    @Nullable
    public static <T extends Parcelable> T getParcelableExtra(@NonNull Intent intent, @Nullable String key) {
        return ensureClassLoader(intent).getParcelableExtra(key);
    }

    @Nullable
    public static Parcelable[] getParcelableArrayExtra(@NonNull Intent intent, @Nullable String key) {
        return ensureClassLoader(intent).getParcelableArrayExtra(key);
    }

    @Nullable
    public static <T extends Parcelable> ArrayList<T> getParcelableArrayListExtra(@NonNull Intent intent, @Nullable String key) {
