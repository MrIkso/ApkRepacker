...
public class ViewUtils {
    ...
    public static void fadeOutThenFadeIn(@NonNull View fromView, @NonNull View toView, boolean gone) {
    ...
    @Px
    public static int dpToPxOffset(@Dimension(unit = Dimension.DP) float dp, @NonNull Context context) {
        return (int) dpToPx(dp, context);
    }

    @Px
    public static int dpToPxSize(@Dimension(unit = Dimension.DP) float dp, @NonNull Context context) {
    ...
    public static int getColorFromAttrRes(@AttrRes int attrRes, int defaultValue, @NonNull Context context) {
    ...
    @Dimension
    public static float getDimensionFromAttrRes(@AttrRes int attrRes, float defaultValue, @NonNull Context context) {
        TypedArray a = context.obtainStyledAttributes(new int[]{attrRes});
        try {
    ...
    @Px
    public static int getDimensionPixelOffsetFromAttrRes(@AttrRes int attrRes, int defaultValue, @NonNull Context context) {
        TypedArray a = context.obtainStyledAttributes(new int[]{attrRes});
        try {
    ...
    @Px
    public static int getDimensionPixelSizeFromAttrRes(@AttrRes int attrRes, int defaultValue, @NonNull Context context) {
        TypedArray a = context.obtainStyledAttributes(new int[]{attrRes});
        try {
    ...
    @AnyRes
    public static int getResIdFromAttrRes(@AttrRes int attrRes, int defaultValue, @NonNull Context context) {
        // TODO: Switch to TintTypedArray when they added this overload.
        TypedArray a = context.obtainStyledAttributes(new int[]{attrRes});
        try {
    ...
    public static int getShortAnimTime(@NonNull View view) {
        return getShortAnimTime(view.getContext().getResources());
    }
    ...
    public static int getMediumAnimTime(@NonNull View view) {
        return getMediumAnimTime(view.getContext().getResources());
    }
    ...
    public static int getLongAnimTime(@NonNull View view) {
        return getLongAnimTime(view.getContext().getResources());
    }
    ...
    @NonNull
    public static View inflateWithTheme(int resource, @NonNull Context context, @StyleRes int themeRes) {
        if (themeRes != 0) {
    ...
    @NonNull
    public static View inflateWithTheme(int resource, @NonNull ViewGroup parent, @StyleRes int themeRes) {
    ...
    @NonNull
    public static View inflateIntoWithTheme(int resource, @NonNull ViewGroup parent, @StyleRes int themeRes) {
        return inflate(resource, parent, true, new ContextThemeWrapper(parent.getContext(),themeRes));
    }

    @NonNull
    private static View inflate(int resource, @Nullable ViewGroup parent, boolean attachToRoot, @NonNull Context context) {
    ...
    public static void setMarginRelative(@NonNull View view, int start, int top, int end, int bottom) {
        ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    public static void setMarginStart(@NonNull View view, int marginStart) {
        MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) view.getLayoutParams(), marginStart);
    }

    public static void setMarginEnd(@NonNull View view, int marginEnd) {
        MarginLayoutParamsCompat.setMarginEnd((ViewGroup.MarginLayoutParams) view.getLayoutParams(), marginEnd);
    }
