...
public class PermissionsUtils {
    ...
    public static boolean checkAndRequestStoragePermissions(Fragment f) {
        if (Build.VERSION.SDK_INT >= 23 && (ActivityCompat.checkSelfPermission(f.requireActivity(), Manifest.permission.READ_EXTERNAL_STORAGE)) == PackageManager.PERMISSION_DENIED) {
