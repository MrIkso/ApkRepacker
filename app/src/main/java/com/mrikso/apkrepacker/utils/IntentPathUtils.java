...
public class IntentPathUtils {
    ...
    @NonNull
    public static Intent putExtraPath(@NonNull Intent intent, @NonNull String path) {
...
//                    return Paths.get(dataUri);
        ...
        Uri extraInitialUri = BundleUtils.getParcelableExtra(intent, DocumentsContract.EXTRA_INITIAL_URI);
