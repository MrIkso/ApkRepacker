...
package com.mrikso.apkrepacker.utils.manifestparser.xml;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

import com.mrikso.apkrepacker.utils.manifestparser.IAbstractFile;
import com.mrikso.apkrepacker.utils.manifestparser.SdkConstants;
import com.mrikso.apkrepacker.utils.manifestparser.StreamException;
import com.mrikso.apkrepacker.utils.manifestparser.resources.Keyboard;
import com.mrikso.apkrepacker.utils.manifestparser.resources.Navigation;
import com.mrikso.apkrepacker.utils.manifestparser.resources.TouchScreen;
    ...
    private static class ManifestHandler extends DefaultHandler {
        ...
        private void processActivityNode(Attributes attributes) {
            ...
            if (activityName != null) {
                ...
                mCurrentActivity = new ManifestData.Activity(activityName, exported);
        ...
        private void processInstrumentationNode(Attributes attributes) {
            ...
            if (instrumentationName != null) {
                ...
                mManifestData.mInstrumentations.add(
                        new ManifestData.Instrumentation(instrClassName, targetPackage));
                mManifestData.mKeepClasses.add(
                        new ManifestData.KeepClass(
