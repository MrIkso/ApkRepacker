...
public abstract class ThemeWrapper {
    ...
    public static ContextThemeWrapper getDialogThemeContext(Context context) {
        return new ContextThemeWrapper(context, isLightTheme() ? R.style.AlertDialog_AppTheme_Light : R.style.AlertDialog_AppTheme_Dark);
    }
}
