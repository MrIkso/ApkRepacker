...
package com.mrikso.apkrepacker.ide.editor.pager;
...
public class EditorPageDescriptor extends SimplePageDescriptor {
    public static final Parcelable.Creator<EditorPageDescriptor> CREATOR = new Parcelable.Creator<EditorPageDescriptor>() {
        @Override
    ...
    private EditorPageDescriptor(Parcel in) {
        super(in);
        file = (File) Objects.requireNonNull(in.readSerializable());
