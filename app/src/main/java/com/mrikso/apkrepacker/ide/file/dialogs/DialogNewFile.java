...
package com.mrikso.apkrepacker.ide.file.dialogs;
...
public class DialogNewFile extends AppCompatDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.dialog_new_file_default, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(requireContext(), android.R.layout.simple_list_item_1, fileExtensions);
...
//        setTitle(R.string.create_new_file);
        ...
        view.findViewById(R.id.btn_select_path).setOnClickListener(v -> selectPath());
    }
