...
public class QickEdit {
    ...
    private void repackApk(File srcApk, File targetApk, String type, String iconName) throws IOException {
        ...
        while ((entry = zin.getNextEntry()) != null) {
            ...
            //add new icon
            if (type != null && iconName != null && ename.startsWith("res/" + type) && ename.endsWith(iconName + ".png")) {
                int length;
                File ic = null;
                for (String dens : IconGenerate.mDens) {
                    if (ename.startsWith("res/" + type + "-" + dens))
                        ic = new File(dir.getAbsolutePath() + File.separator + dens + File.separator + iconName + ".png");
                }
                if (ic == null)
                    ic = new File(dir.getAbsolutePath() + File.separator + "xxxhdpi" + File.separator + iconName + ".png");
