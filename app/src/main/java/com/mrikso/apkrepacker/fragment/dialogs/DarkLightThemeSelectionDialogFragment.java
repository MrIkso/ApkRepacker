...
public class DarkLightThemeSelectionDialogFragment extends BaseBottomSheetDialogFragment implements ThemeSelectionDialogFragment.OnThemeChosenListener {
    ...
    protected View onCreateContentView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.bottom_sheet_dialog_dark_light_theme_selection, container, false);
    }
    ...
    protected void onContentViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getPositiveButton().setOnClickListener(v -> {
            if (mMode == MODE_CHOOSE) {
                OnDarkLightThemesChosenListener listener = FragmentUtils.getParentAs(this, OnDarkLightThemesChosenListener.class);
                if (listener != null)
        ...
        ThemeView lightThemeView = view.findViewById(R.id.theme_view_dl_selection_light);
        ThemeView darkThemeView = view.findViewById(R.id.theme_view_dl_selection_dark);
