...
public class EditorDelegate implements TextWatcher, IEditorDelegate {
    ...
    private final Runnable mGetSuggestion = () -> performGetSuggestion();
    ...
    void onLoadFinish() {
        ...
        mEditText.post(() -> {
            if (savedState.cursorOffset < mEditText.getText().length()) {
                if(mEditText.getSelectionStart() != -1 )
 ...
 */
    ...
    public void addHighlight(int start, int end) {
        ...
        //mEditText.getLineForOffset(end);
    }

    public void clearSelectable(){
       // mEditText.removeSelection
       // mEditText.hasFocus();
     //   mEditText.requestFocus();
/*
    ...
    public void doCommand(Command command) {
        ...
        switch (command.what) {
            ...
            case SAVE_AS:
                ...
                break;
            case FIND:
                getActivity().initSearchPanel(this);
                break;
            case HIGHLIGHT:
