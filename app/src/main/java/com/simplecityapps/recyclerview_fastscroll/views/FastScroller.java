...
public class FastScroller {
    ...
    private com.simplecityapps.recyclerview_fastscroll.views.FastScrollRecyclerView mRecyclerView;
    private com.simplecityapps.recyclerview_fastscroll.views.FastScrollPopup mPopup;
    ...
    public FastScroller(Context context, com.simplecityapps.recyclerview_fastscroll.views.FastScrollRecyclerView recyclerView, AttributeSet attrs) {

        Resources resources = context.getResources();

        mRecyclerView = recyclerView;
        mPopup = new com.simplecityapps.recyclerview_fastscroll.views.FastScrollPopup(resources, recyclerView);
