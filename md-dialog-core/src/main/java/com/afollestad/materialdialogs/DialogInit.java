...
/*        boolean textAllCaps;
        ...
        Button positiveTextView = dialog.positiveButton;
        dialog.setTypeface(positiveTextView, Typeface.DEFAULT_BOLD);
...
//        dialog.positiveButton.setDefaultSelector(dialog.getButtonSelector(DialogAction.POSITIVE, false));
        ...
        Button negativeTextView = dialog.negativeButton;
        dialog.setTypeface(negativeTextView, Typeface.DEFAULT_BOLD);
...
//        dialog.negativeButton.setDefaultSelector(dialog.getButtonSelector(DialogAction.NEGATIVE, false));
        ...
        Button neutralTextView = dialog.neutralButton;
        dialog.setTypeface(neutralTextView, Typeface.DEFAULT_BOLD);
