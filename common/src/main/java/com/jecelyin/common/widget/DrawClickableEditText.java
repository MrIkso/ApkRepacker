...
public class DrawClickableEditText extends EditText {
    ...
    public interface DrawableClickListener {
        void onClickDrawEditText(DrawClickableEditText editText, DrawablePosition target);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (drawableBottom != null
                ...
                clickListener.onClickDrawEditText(this, DrawablePosition.BOTTOM);
                return super.onTouchEvent(event);
            }

            if (drawableTop != null
                    && drawableTop.getBounds().contains(actionX, actionY)) {
                clickListener.onClickDrawEditText(this, DrawablePosition.TOP);
                return super.onTouchEvent(event);
            }
            ...
            if (drawableLeft != null) {
                ...
                if (actionX < dX && clickListener != null) {
                    clickListener.onClickDrawEditText(this, DrawablePosition.LEFT);
            ...
            if (drawableRight != null) {
                ...
                if(actionX > dX && clickListener != null) {
                    clickListener.onClickDrawEditText(this, DrawablePosition.RIGHT);
                    event.setAction(MotionEvent.ACTION_CANCEL);
                    return false;
                }
            }
