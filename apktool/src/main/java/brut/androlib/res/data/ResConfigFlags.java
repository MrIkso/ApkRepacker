...
public class ResConfigFlags {
    ...
    public ResConfigFlags(short mcc, short mnc, char[] language,
        ...
        if (orientation < 0 || orientation > 3) {
            LOGGER.warning(R.string.log_text,"Invalid orientation value: " + orientation);
            orientation = 0;
            isInvalid = true;
        }
        if (touchscreen < 0 || touchscreen > 3) {
            LOGGER.warning(R.string.log_text,"Invalid touchscreen value: " + touchscreen);
            touchscreen = 0;
            isInvalid = true;
        }
        if (density < -1) {
            LOGGER.warning(R.string.log_text,"Invalid density value: " + density);
            density = 0;
            isInvalid = true;
        }
        if (keyboard < 0 || keyboard > 3) {
            LOGGER.warning(R.string.log_text,"Invalid keyboard value: " + keyboard);
            keyboard = 0;
            isInvalid = true;
        }
        if (navigation < 0 || navigation > 4) {
            LOGGER.warning(R.string.log_text,"Invalid navigation value: " + navigation);
            navigation = 0;
            isInvalid = true;
        }
    ...
    public final static int SDK_Q = 29;
